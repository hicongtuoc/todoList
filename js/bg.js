const UNSPLASH_API_KEY =
  "JWY_gZVoETIvX48SWfBTQUlDrfPaVifLw2fDxI_KD9g";
const UNSPLASH_URL = `https://api.unsplash.com/photos/random/?client_id=${UNSPLASH_API_KEY}&query=scenic&orientation=landscape`;
